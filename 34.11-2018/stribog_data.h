...
#include "types.h" //заголовочный файл с масками для типов данных

const u8 iv512[64] = {  // массив 8ми битных целых чисел размером 64 заполнен нулями в 16тиричной сс (для длины хэша 512 бит)
...
const u8 iv256[64] = {  // массив 8ми битных целых чисел размером 64 заполнен единицами в 16тиричной сс (для длины хэша 256 бит)
...
const u8 sbox[256] = { // массив 8ми битных целых чисел размером 256 заполнен различными числами в 16тиричной сс (для длины хэша 256 бит)
...
const u64 A[64] = { // массив 64ёх битных целых чисел размером 64 заполнен различными числами в 16тиричной сс
...
static u8 C[12][64] = { // дмуиерный массив 8ми битных целых чисел размером 12 на 64 заполнен различными числами в 16тиричной сс 
	{
